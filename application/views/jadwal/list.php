    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <table class="table table-bordered">
                ...
                <tr><td>KELAS</td><td>
                        <select id="kelas" class="form-control" onchange="loadkelas()()">
                ...
                <tr><td>kelas</td><td><div id="showkelas"></div></td></tr>
                <tr><td colspan="2">
...
<script type="text/javascript">
    ...
    function loadkelas(){
        ...
        $.ajax({
            type:'GET',
            url :'<?php echo base_url() ?>index.php/jadwal/show_kelas',
    ...
    function loadPelajaran(){
        ...
        $.ajax({
            ...
            data:'jurusan='+jurusan+'&kelas='+kelas+'&kelas='+kelas+'&id_kurikulum=<?php echo $this->uri->segment(3) ?>',
            success:function(html){
                $("#tabel").html(html);
                //loadkelas();
            }
