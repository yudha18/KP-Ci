    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" value="<?php echo $siswa['Alamat'] ?>" name="Alamat" placeholder="MASUKKAN ALAMAT" id="form-field-1" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="form-field-1">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                   <?php echo cmb_dinamis('kelas', 'tbl_kelas', 'nama_kelas', 'id_kelas',$siswa['id_kelas'])?>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="form-field-1">
