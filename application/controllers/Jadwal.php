...
Class jadwal extends CI_Controller{
    ...
    function dataJadwal(){
        ...
        $sql = "SELECT  tj.hari,tj.id_jadwal,tm.nama_mapel,tg.id_guru,tg.nama_guru,tr.kd_ruangan,tj.hari,tj.jam
                ...
                and tj.kelas='$kelas' and tj.kd_jurusan='$kd_jurusan' and tj.id_kelas=$kelas";
   ...
   function updateRuangan(){
    ...
    function getPelajaran($jam,$hari,$kelas){
        $sql = "SELECT tj.*,tm.nama_mapel
                ...
                WHERE tj.kd_mapel=tm.kd_mapel and tj.id_kelas=$kelas and tj.hari='$hari' and tj.jam='$jam'";
