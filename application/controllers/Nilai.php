...
class Nilai extends CI_Controller{
    ...
    function index(){
        ...
        $sql = "SELECT tj.id_kelas,tj.id_jadwal,tjr.nama_jurusan,tj.kelas,tm.nama_mapel,tj.jam,tr.nama_ruangan,tj.hari,tj.semester
    ...
    function update_nilai(){
        ...
        // parameter
        $params = array('nim'=>$nim,'id_jadwal'=>$id_jadwal,'ulangan'=>$ulangan,'uts'=>$uts,'uas'=>$uas);
        ...
        if($chek->num_rows()>0){
            ...
            $this->db->update('tbl_nilai',array('ulangan'=>$ulangan,'uts'=>$uts,'uas'=>$uas));
        }else{
            // proses insert
